package com.payline.payment.swish.utils.security;
...
class RSAHolderTest {
    ...
    @BeforeAll
    static void setup() {
        PartnerConfiguration partnerConfiguration = TestUtils.createPartnerConfiguration();
        pemCertificate = partnerConfiguration.getProperty(AbstractHttpClient.PARTNER_CONFIGURATION_CERT);
        pemPk = partnerConfiguration.getProperty(AbstractHttpClient.PARTNER_CONFIGURATION_PK);
    }
